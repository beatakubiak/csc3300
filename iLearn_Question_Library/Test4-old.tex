...
\begin{tikzpicture}[node distance=1.5cm]
    ...
    \node[box, fill=white, below=0cm of publisher_header.south, anchor=north, minimum height=1.5cm, minimum width=2cm] (publisher_body) {name\\address\\phone\\URL};
    ...
    \node[box, fill=white, below=0cm of customer_header.south, anchor=north, minimum height=1.4cm, minimum width=2cm] (customer_body) {email\\name\\address\\phone};
    ...
    % Warehouse table
    \node[box, fill=white, anchor=north, minimum height=1.2cm, minimum width=2cm, right=1.5cm of stocks] (warehouse_body) {code\\address\\phone};
...
\begin{tikzpicture}[node distance=1.5cm]
    ...
    \node[box, fill=white, below=0cm of album_header.south, anchor=north, minimum height=1cm, minimum width=2.5cm] (match_body) {\underline{match\_id}\\date\\stadium\\opponent\\own\_score\\opp\_score};
